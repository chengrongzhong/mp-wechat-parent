...
import com.qq.bean.menu.Menu;
import com.qq.bean.menu.MenuButton;
import com.qq.bean.menu.MenuType;
...
//        result.printErrInfo();
    ...
    private static String buildMenu1(){
        ...
        subBtn1.add(MenuButton.newViewButton("视频","3","http://v.qq.com/"));
    ...
    private static String buildMenu(){
        String  result= "";
        List<MenuButton> subBtn1 = new ArrayList<MenuButton>();
        subBtn1.add(MenuButton.newViewButton("进入群聊", "2", "http://jq.qq.com/?_wv=1027&k=28l30Pd"));
