...
public class JsUtil {
	...
	public static String generateConfigJson(String jsapi_ticket,boolean debug,String appId,String url,String... jsApiList){
		...
		String nonceStr = Uuid.uuid();
		String signature = generateConfigSignature(nonceStr, jsapi_ticket,String.valueOf(timestamp),url);
	...
	public static Map<String,Object> generateConfigMap(String jsapi_ticket,boolean debug,String appId,String url,String... jsApiList){
		String timestamp = String.valueOf(System.currentTimeMillis()/1000);
		String nonceStr = Uuid.uuid();
		String signature = generateConfigSignature(nonceStr, jsapi_ticket, timestamp, url).toLowerCase();
