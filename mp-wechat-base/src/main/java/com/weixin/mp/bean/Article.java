...
public class Article {
	...
	public static Article newArticle(String title,String thumb_media_id,String author,String content_source_url,String content,String digest,String show_cover_pic){
		...
		article.setShow_cover_pic(show_cover_pic);
		return article;
	}
}
