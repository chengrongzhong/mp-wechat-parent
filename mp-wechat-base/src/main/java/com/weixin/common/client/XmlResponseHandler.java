package com.weixin.common.client;
...
public class XmlResponseHandler{
	...
	private static Map<String, ResponseHandler<?>> map = new java.util.concurrent.ConcurrentHashMap<String, ResponseHandler<?>>();
			...
			ResponseHandler<T> responseHandler = new ResponseHandler<T>() {
				...
				public T handleResponse(HttpResponse response)
	                ...
	                if (status >= 200 && status < 300) {
						...
						return XMLConverUtil.convertToObject(clazz,entity.getContent());
